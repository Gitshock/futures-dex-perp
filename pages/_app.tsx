...
const PageTitle = () => {
  ...
  return (
    <Head>
      <title>{marketTitleString}Gitshock Finance | Open Edgeware dEX Multichain</title>
    </Head>
  )
}
...
function App({ Component, pageProps }) {
  ...
  return (
    <>
      <Head>
        <title>Gitshock Finance | Open Edgeware dEX Multichains</title>
        <link rel="icon" href="/favicon.ico" />
        <meta property="og:title" content="Gitshock Finance | Open Edgeware dEX Multichains" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="keywords"
          content="Gitshock Finance | Open Edgeware dEX Multichains, Gitshock Serum, SRM, Serum DEX, DEFI, Decentralized Finance, Decentralised Finance, Crypto, ERC20, Ethereum, Decentralize, Solana, SOL, SPL, Cross-Chain, Trading, Fastest, Fast, SerumBTC, SerumUSD, SRM Tokens, SPL Tokens"
        />
        <meta
          name="description"
          content="Gitshock Finance | Open Edgeware dEX Multichains - Decentralised, Gitshock, cross-margin trading up to 10x leverage with lightning speed and near-zero fees."
        />
        <link
        ...
        <meta name="twitter:title" content="Gitshock Finance" />
        <meta
          name="twitter:description"
          content="Open Edgeware dEX - Decentralized, Platform Cross-Chain Token."
        />
        <meta
          name="twitter:image"
